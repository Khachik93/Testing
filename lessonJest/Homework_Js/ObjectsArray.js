...
// console.log(getInvestmentMoney(PeopleInfo))
// console.log(getInvestmentInfo(PeopleInfo))
console.log(getThreeMaxInvestors(PeopleInfo))
module.exports={getInvestmentMoney, getInvestmentInfo,getThreeMaxInvestors,}